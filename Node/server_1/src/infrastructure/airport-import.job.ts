...
// Seeds the airport store from the public OpenFlights airport dataset. It runs
// through the airport use cases, so it is invoked at startup from index.ts rather
// than as a standalone script.
const AIRPORTS_URL =
